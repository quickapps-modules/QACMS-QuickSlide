<?php
	...
	$__attr = array(
		'tool_labels' => __d('quick_slide', 'Gallery,Previous Group,Previous,Next,Next Group,Pause,Play,Full Screen,Normal Screen,Open Link,Open Gallery'),
		'text_strings' => __d('quick_slide', 'Previous Screen,Next Screen,Screen,of,No caption,No title,Playing,Paused,Click play to start audio'),
		'xml_file_path' => false,
